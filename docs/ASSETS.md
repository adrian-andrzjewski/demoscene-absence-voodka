...
| 6 | `_logo2.inc` | 9,702 | logo graphic | P1 (`logo2`) |
| 7 | `_logo3.inc` | 6,300 | logo graphic | P1 (`logo3`) |
| 8 | `_logo4.inc` | 6,804 | logo graphic | P1 (`logo4`) |
| 9 | `_wlk1.dat` | 64,000 | 320x200 screen | P1 (`_znik1`, "znika" pixel-fade frames) |
| 10 | `_wlk2.dat` | 64,000 | 320x200 screen | P1 (`_znik2`) |
| 11 | `_wlk3.dat` | 64,000 | 320x200 screen | P1 (`_znik3`) |
| 12 | `wall.v3d` | 140 | VR object (1 wall) | P2 world |
| 13 | `wall2.v3d` | 140 | VR object | P2 world |
| 14 | `wall3.v3d` | 140 | VR object | P2 world |
| 15 | `torus.v3d` | 15,212 | VR object (torus) | P2 world |
| 16 | `klatki.dat` | 147,456 | 36 frames x 4096 B (64x64 anim) | P2 (`sun` sprite) |
...
| 32 | `2wall2.v3d` | 140 | VR object | P5 world |
| 33 | `2wall3.v3d` | 140 | VR object | P5 world |
| 34 | `2torus.v3d` | 5,668 | VR object | P5 world |
| 35 | `2torus.v3m` | 5,632 | VR morph target | P5 (`_torusMorph`) |
| 36 | `do_water` | 16,384 | 128x128 water picture (no extension) | P5 (`_obrazek`) |
| 37 | `2WORLD.PAL` | 768 | palette | P5 (`_pal`) |
| 38 | `2ENV.DAT` | 65,536 | 256x256 env map | P5 (`fn` textures) |
| 39 | `2T001.DAT` | 32,768 | texture | P5 (`fn`) |
| 40 | `2T002.DAT` | 32,768 | texture | P5 (`fn`) |
| 41 | `w1.DAT` | 64,000 | 320x200 screen | P5 phase pics (`_adr1`) |
| 42 | `w2.DAT` | 64,000 | 320x200 screen | P5 (`_voodka2`) |
...
| 61 | `stc.dat` | 32,000 | water phase data | P7 phase 3 |
| 62 | `tcman.dat` | 16,000 | water phase pic | P7 phase 4 |
...
- `dane\voodka.dat` (index 45) is a 1-byte placeholder inside DANE - it
  ...
  other file. P5 references it (`vodka 45,_voodka`) but a 1-byte payload is
  effectively unused.
- Two DANE files are **not** in the manifest and are never packed:
  `OBRAZEK.PAL` (768 B, palette for `obrazek.dat` - P2 installs its world
